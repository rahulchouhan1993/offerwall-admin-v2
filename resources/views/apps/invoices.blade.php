    ...
    <div class="bg-[#f2f2f2] p-[15px] lg:p-[35px]">
        ...
        <div class="w-full flex flex-wrap md:flex-nowrap items-center gap-[15px] mb-[30px]">
            ...
            <div
                ...
                <h3 class="text-[20px] md:text-[24px] font-[700] text-[#000]">{{ $paidCount }} | $ {{ number_format($paidAmount,2) }}</h3>
            </div>
        </div>
                    ...
                    <form method="GET" action="{{ route('apps.invoices') }}">
                        <div class="flex flex-wrap md-flex-nowrap items-start gap-[7px] md:gap-[15px] justify-end ">
                            ...
                            <div class="relative w-full md:w-auto">
                                <button type="submit"
                                    class="w-full md:w-[110px] lg:w-[140px] bg-[#49FB53] px-[20px] py-[10px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#000] text-center">Apply</button>
                            </div>
                ...
                <div class="space-y-4 mt-4">
                    ...
                    <div class="flex justify-end space-x-2 mt-4">
                        <button type="button" onclick="closeModal()"
                            class="px-4 py-2 bg-[#ffe3e3] w-[100px] border border-[#FED5C3] rounded-[4px] text-[14px] font-[500] text-[#f00000] text-center">Cancel</button>
