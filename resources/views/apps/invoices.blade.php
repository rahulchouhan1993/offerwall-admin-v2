...
<div class="bg-[#f2f2f2] p-[15px] lg:p-[35px]">
    ...
    <div class="w-full flex flex-wrap md:flex-nowrap items-center gap-[15px] mb-[30px]">
        <div
            ...
            <h2 class="text-[18px] font-[500] text-[#fff]">Pending</h2>
            <h3 class="text-[38px] font-[700] text-[#fff]">10 | 500$</h3>
        </div>
        <div
            ...
            <h2 class="text-[18px] font-[500] text-[#fff]">Paid</h2>
            <h3 class="text-[38px] font-[700] text-[#fff]">10 | 500$</h3>
        </div>
    </div>
    <div class="flex flex-col lg:flex-row justify-between items-start gap-[15px] w-full">
        <div class="w-full bg-white p-[15px] md:p-[20px] rounded-[10px] custom_filter">
            <form >
                <div  class="flex flex-wrap md-flex-nowrap items-start gap-[15px] justify-end mb-[15px]" >
                    <div class="relative w-[100%] sm:w-[200px]">
                        <input name="range" class="date-range-profit w-[100%] lg:w-[100%] bg-[#F6F6F6] px-[15px] py-[10px] text-[13px] font-[600] text-[#4D4D4D] border-[1px] border-[#E6E6E6] rounded-[4px] hover:outline-none focus:outline-none" type="text" value="">
                    </div>
                    ...
                    <div class="relative w-[100%] sm:w-[220px]">
                        <select name="affiliate_id2" class=" select-affiliate-dash  affiliate-profit z-2 absolute mt-1 w-[100%] rounded bg-[#F6F6F6] border-[1px] border-[#E6E6E6] rounded-[5px] text-[13px] font-[600] text-[#4D4D4D]" x-show="open">
                            <option value="">Select Affiliate</option>
                        </select>
                    </div>
                    <div class="relative">
                        <button type="submit" class="w-[100px] md:w-[110px] lg:w-[140px] bg-[#4EF953] px-[20px] py-[10px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center">+ Add</button>
                    </div>
                </div>
            </form>
            <div class="overflow-x-scroll tableScroll">
                <table
                    class="w-full border-collapse border-spacing-0 rounded-[10px] border-separate border border-[#E6E6E6]">
                    <thead>
                        <tr>
                            <th
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <div class="flex justify-start items-center gap-[7px]">
                                    <a href="#">
                                        <svg class="w-[15px] h-[15px]" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4 5H3C2.46957 5 1.96086 5.21071 1.58579 5.58579C1.21071 5.96086 1 6.46957 1 7V16C1 16.5304 1.21071 17.0391 1.58579 17.4142C1.96086 17.7893 2.46957 18 3 18H12C12.5304 18 13.0391 17.7893 13.4142 17.4142C13.7893 17.0391 14 16.5304 14 16V15" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M13 3L16 6M17.385 4.585C17.7788 4.19115 18.0001 3.65698 18.0001 3.1C18.0001 2.54302 17.7788 2.00885 17.385 1.615C16.9912 1.22115 16.457 0.999893 15.9 0.999893C15.343 0.999893 14.8088 1.22115 14.415 1.615L6 10V13H9L17.385 4.585Z" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                            
                                    </a>
                                    <a href="#"
                                        class="rounded-[5px] flex items-center text-[17px] text-red-500">
                                        <svg class="w-[17px] h-[17px]" width="20" height="20" xmlns="http://www.w3.org/2000/svg"
                                            fill="currentColor" viewBox="0 0 284.011 284.011">
                                            <g>
                                                <g>
                                    ...
                                    <a href="#">
                                        <svg class="w-[15px] h-[15px]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10 13V1M19 13V17C19 17.5304 18.7893 18.0391 18.4142 18.4142C18.0391 18.7893 17.5304 19 17 19H3C2.46957 19 1.96086 18.7893 1.58579 18.4142C1.21071 18.0391 1 17.5304 1 17V13" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M5 8L10 13L15 8" stroke="#808080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
