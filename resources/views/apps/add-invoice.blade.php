    ...
    /> --}}
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse text-sm min-w-[600px]">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3">
                                <button class="rounded-sm bg-[#4EF953] px-4 py-1 text-white">
                                    + add
                                </button>
                            </td>
            ...
            <div class="mt-[50px] text-sm text-[#000000] leading-relaxed">
                ...
                <p class="mb-2">
                    ...
                    information:<br />
                    <a href="mailto:support@makamobile.com" class="text-[#4EF953]">support@makamobile.com</a>,
                    <a href="mailto:finance@makamobile.com" class="text-[#4EF953]">finance@makamobile.com</a>.
                </p>
            ...
            <div class="mt-[30px] md:mt-[70px]">
                ...
                <div class="mt-[30px] overflow-x-auto">
                    <table class="document-details w-full min-w-[500px] border-collapse text-sm text-[#666]">
                        ...
                        <tbody>
                            <tr>
                                <td class="border-b-[1px] border-[#777] p-[.4em] text-left align-top"><input type="text"
                                        name="" id=""
                ...
                <div class="mt-[60px] border-t-[1px] pt-[20px] text-xs text-[#000000]">This invoice is system generated, if
                    you have any question feel free to reach out to us.</div>
            </div>
        </div>
    </div> --}}
