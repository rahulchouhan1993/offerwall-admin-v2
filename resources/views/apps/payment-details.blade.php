            ...
            <div class="flex flex-wrap gap-x-[20px] gap-y-[30px] w-[100%] ">
                <div class="flex flex-col gap-[10px] w-[100%] ">
                    ...
                    <select name="method" required class="payment-method flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none">
                        ...
                        <option value="1" @if($paymentDetails->payment_method==1) selected @endif>ACH/SWIFT (Wise)</option>
                        <option value="2" @if($paymentDetails->payment_method==2) selected @endif>Crypto</option>
                        <option value="3" @if($paymentDetails->payment_method==3) selected @endif>Paypal</option>
                    </select>
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-wrap gap-x-[20px] gap-y-[30px] w-[100%] ">
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        ...
                        <select name="account_type"  class="account-type-sel flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none">
                            <option value="">Select Option</option>
                            <option value="ACH" @if($paymentDetails->account_type=='ACH') selected @endif>ACH</option>
                            <option value="SWIFT" @if($paymentDetails->account_type=='SWIFT') selected @endif>SWIFT</option>
                        </select>
                    </div>
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        ...
                        <input type="text" name="org_name"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->account_name }}">
                    </div>
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        ...
                        <input type="text" name="routing_number"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->routing_number }}">
                    </div>
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        ...
                        <input type="text" name="account_number"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->iban }}">
                    </div>
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        ...
                        <select name="country" class="select-country-met flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none">
                            ...
                            @foreach ($allCountries as $country )
                                <option value="{{ $country->iso }}" @if($paymentDetails->country==$country->iso) selected @endif>{{ $country->nicename }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        <label for="" class="flex items-center gap-[5px] text-[14] text-[#898989]">City <div class="text-[#F23765] mt-[-2px]">*</div></label>
                        <input type="text" name="city"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->city }}">
                    </div>
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        <label for="" class="flex items-center gap-[5px] text-[14] text-[#898989]">Recipient Address <div class="text-[#F23765] mt-[-2px]">*</div></label>
                        <input type="text" name="address"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->address }}">
                    </div>
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        <label for="" class="flex items-center gap-[5px] text-[14] text-[#898989]">Post Code<div class="text-[#F23765] mt-[-2px]">*</div></label>
                        <input type="text" name="post_code"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->post_code }}">
                    </div>
                </div>
            </div>
            <div class="section-2 common-section" style="display:none">
                <div class="flex flex-wrap gap-x-[20px] gap-y-[30px] w-[100%] ">
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        ...
                        <input type="text" name="wallet_address"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->wallet_address }}">
                    </div>
                </div>
            </div>
            <div class="section-3 common-section" style="display:none">
                <div class="flex flex-wrap gap-x-[20px] gap-y-[30px] w-[100%] ">
                    <div class="flex flex-col gap-[10px] w-[100%] ">
                        ...
                        <input type="email" name="paypal_email"  class="flex px-[15px] py-[15px] rounded-[10px] bg-[#F6F6F6] text-[14px] text-[#4D4D4D] font-[600] hover:outline-none focus:outline-none" value="{{ $paymentDetails->paypal_email }}">
                    </div>
                </div>
            </div>
        </div>
