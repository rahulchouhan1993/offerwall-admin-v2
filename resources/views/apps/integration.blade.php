                ...
                <div class="w-full flex flex-col flex-wrap  w-[100%] ">
                    <div class="flex items-center justify-between py-[20px] gap-[15px] border-b-[1px] border-b-[#E6E6E6]">
                        <div class="flex items-center justify-between gap-[10px]">
                            <div class="flex items-center justify-between w-[46px] h-[46px] bg-[#49FB53] px-[2px] py-[1px] rounded-[4px] text-[14px] font-[500] text-[#000] text-center"><svg class="m-auto" width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="w-[100%] xl:w-[60%] bg-[#fff] p-[12px] lg:p-[15px] xl:p-[20px] rounded-[8px] md:rounded-[10px]">
                ...
                <div class="mt-[18px] mb-[15px]">
                    ...
                    <code class="flex items-center justify-center bg-[#1E233B] h-[100%] xl:h-[125px] rounded-[8px] px-[15px] py-[15px] text-[14px] text-[#FFFFFF]"  data-lang="html">
                            ...
                            &lt;iframe style="width:100%; height:800px; border:0; padding:0; margin:0;" scrolling="yes" frameborder="0" src="{{ env('OFFRWALL_URL') }}/wall?apiKey={{ $affiliateDetails->api_key }}&wallId={{ $appDetail->appId }}">&gt;&lt;/iframe&gt;
